...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'RelatedPosts', fields ['post', 'similar_post']
        db.create_unique(u'posts_relatedposts', ['post_id', 'similar_post_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'RelatedPosts', fields ['post', 'similar_post']
        db.delete_unique(u'posts_relatedposts', ['post_id', 'similar_post_id'])
