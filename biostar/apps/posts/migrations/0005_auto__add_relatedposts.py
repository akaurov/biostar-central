...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'posts_relatedposts', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'related_post', to=orm['posts.Post'])),
            ('similar_post', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'similar_post', to=orm['posts.Post'])),
            ('type', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'posts', ['RelatedPosts'])


    def backwards(self, orm):
        # Deleting model 'RelatedPosts'
        db.delete_table(u'posts_relatedposts')
